...
For more information about the datasets and the variables they contain, please consult [the code book](../sehc_code_book.pdf). (https://github.com/jojolindholm/sehc/blob/main/sehc_code_book.pdf).
